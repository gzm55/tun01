...
namespace antlersoft {
  ...
  MyException::MyException(stringstream&& msg_stream, const char* const file, const int line) {
  ...
  MyException::MyException(const char* const msg, const char* const file, const int line)
      : MyException(static_cast<stringstream&&>(stringstream() << msg), file, line) {}

  MyException::MyException(const char* file, int line)
      : MyException(static_cast<stringstream&&>(stringstream()
                                                << "Error: " << errno << cerr_endl()
